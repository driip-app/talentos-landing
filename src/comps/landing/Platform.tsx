      ...
      <div className="platform-inner">
        ...
        <div className="platform-grid">
          ...
          <div className="agent-card a2">
            <div className="agent-num mono">Agent Sync</div>
            <div className="agent-name syne">Schedule Coordinator</div>
            <div className="agent-desc">Identifies the panel, checks their calendar, resolves conflicts, confirms the interview mode, and sends the invitation.</div>
            <div className="agent-saving"><span className="saving-icon">⏱</span><span className="saving-text mono">5–10 HRS SAVED / HIRE</span></div>
          </div>
          <div className="agent-card a3">
            <div className="agent-num mono">Agent Pulse</div>
            <div className="agent-name syne">Talent Relations Manager</div>
            <div className="agent-desc">No more ghosting candidates. Every applicant receives an automatic status email at each stage within 72 hours.</div>
            <div className="agent-saving"><span className="saving-icon">⏱</span><span className="saving-text mono">8–12 HRS SAVED / HIRE</span></div>
          </div>
          <div className="agent-card a1">
